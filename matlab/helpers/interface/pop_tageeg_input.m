...
title = 'Input HED tag info - pop_tageeg_input()';
inputFig = figure( ...
    'Color', [.66 .76 1], ...
    'MenuBar', 'none', ...
    'Name', title, ...
...
%         createExtensionPanel();
    ...
    function createExtensionPanel()
        ...
        bg = uibuttongroup('Title', 'HED extension options', ...
            ...
            'ForegroundColor', [0 0 0.4],...
            'BorderType', 'line',...
            'HighlightColor', [0 0 0.4],...
            'Position', [0.17 .5 .65 .3],...
            'FontSize',14, ...
            'FontWeight','bold',...
...
%     end % extensionsCallback
    ...
    function createOptionsGroupPanel()
        ...
        optionGroupPanel = uipanel('BackgroundColor',[.66,.76,1],...
            'ForegroundColor', [0 0 0.4],...
            'BorderType', 'line',...
            'HighlightColor', [0 0 0.4],...
            'FontSize',14,...
            ...
            'FontWeight','bold',...
            'Position',[0.17 .2 .65 .5]);
        uicontrol('Parent', optionGroupPanel, ...
            'Style', 'CheckBox', 'Tag', 'UseGUICB', ...
            'BackgroundColor', [.66 .76 1],...
            'ForegroundColor', [0 0 0.4],...
            'String', 'Use CTagger to add/modify tags/schema', 'Enable', 'on', 'Tooltip', ...
        ...
        uicontrol('Parent', optionGroupPanel, ...
            ...
            'BackgroundColor', [.66 .76 1],...
            'ForegroundColor', [0 0 0.4],...
            'String', 'Select EEG.event fields to use for tagging', 'Enable', 'on', 'Tooltip', ...
            'If checked, use menu to select fields to tag', ...
            'Units','normalized', ...
            'Value', selectEventFields, ...
            'Callback', @selectFieldsCallback, ...
            'Position', [0.17 0.37 0.8 0.33]);
        uicontrol('Parent', optionGroupPanel, ...
            'Style', 'CheckBox', 'Tag', 'ExtendHEDCB', ...
            'BackgroundColor', [.66 .76 1],...
            'ForegroundColor', [0 0 0.4],...
            'Enable', 'on', ...
            'Units','normalized', ...
            'Value', false, ...
            'Callback', @extensionsCallback, ...
            'Position', [0.17 0.1 0.25 0.33]);
        uicontrol('Parent', optionGroupPanel, ...
            'Style', 'Text', ...
            'BackgroundColor', [.66 .76 1],...
            'ForegroundColor', [0 0 0.4],...
            'String', 'Allow new HED tags (if compatible with the HED schema)', 'Enable', 'on', 'Tooltip', ...
            'If checked, allow extension of HED schema where compatible with the schema definition', ...
            'Units','normalized', ...
            'HorizontalAlignment', 'left',...
            'Position', [0.23 0 0.8 0.33]);
...
%             'Position', [0.17 0 0.8 0.33]);
    ...
    function extensionsCallback(src, ~)
        % Callback for HED extension edit box
        hedExtensionsAllowed = logical(get(src, 'Value'));
