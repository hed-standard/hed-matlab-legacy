...
% Usage:
%
%   >>  [canceled, generateWarnings, hedXML, outDir] = pop_validatestudy_input()
%
%   >>  [canceled, generateWarnings, hedXML, outDir] = ...
%       pop_validatestudy_input('key1', 'value1', ...)
%
% Input:
%
%   Optional:
...
[tmp1, tmp2, strhalt, structout] = inputgui( geometry, uilist, ...
           'pophelp(''pop_validatestudy'');', 'Validate STUDY -- pop_validatestudy()');
