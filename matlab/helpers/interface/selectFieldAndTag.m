...
uilist = {...
    ...
    {'Style', 'popupmenu', 'string', fields, 'Value', find(cellfun(@(x) ~isempty(x),strfind(fields,primaryField))), 'tag', 'primaryFieldBox'} ...
    {'Style', 'text', 'string', 'Click "Ok" to continue when finish tagging'}};

%% Waiting for user input
[tmp1, tmp2, strhalt, structout] = inputgui( 'geometry', geometry, 'geomvert',[1 8 1.3 1 1], 'uilist', uilist, ...
